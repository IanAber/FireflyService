...
func RegisterWebSiteAPICalls(router *mux.Router) {
	...
	RegisterWebSiteAPI(router, "/setFuelCell/TargetBattLow/{volts}", "", "PUT", "Set the batery low voltage set point", setFcBatLow)
	...
	RegisterWebSiteAPI(router, "/setFuelCell/ExhaustOpen", "", "PUT", "Start the water pump on high and beginn air removal", exhaustOpen)
	...
	RegisterWebSiteAPI(router, "/FuelCellData/Pressures", "start=datetime&end=datetime", "GET", "Get the historical data for the fuel cell pressures. Take start and end parameters to determing the time span.", getFuelCellPressureData)
	RegisterWebSiteAPI(router, "/FuelCellData/Coolant", "start=datetime&end=datetime", "GET", "Get the historical data for the fuel cell coolant. Take start and end parameters to determing the time span.", getFuelCellCoolantData)
	RegisterWebSiteAPI(router, "/Electrolyser/Data/{electrolyser}", "start=datetime&end=datetime", "GET", "Get the historical data for the electrolyser. Take start and end parameters to determing the time span.", getElectrolyserData)
	RegisterWebSiteAPI(router, "/Analog/Data", "start=datetime&end=datetime", "GET", "Get the historical data for the analog inputs. Take start and end parameters to determing the time span.", getAnalogData)
	RegisterWebSiteAPI(router, "/AC/Data", "start=datetime&end=datetime", "GET", "Get the historical data for the AC devices. Take start and end parameters to determing the time span.", getACData)
	RegisterWebSiteAPI(router, "/DC/Data", "start=datetime&end=datetime", "GET", "Get the historical data for the DC devices. Take start and end parameters to determing the time span.", getDCData)
	RegisterWebSiteAPI(router, "/Hydrogen/Data", "start=datetime&end=datetime", "GET", "Get the historical data for the Hydrogen storage. Take start and end parameters to determing the time span.", getHydrogenData)
	RegisterWebSiteAPI(router, "/Power/Data", "source=firefly&start=datetime&end=datetime", "GET", "Get the historical data for the battery and solar inputs. Take start and end parameters to determing the time span.", getPowerData)
